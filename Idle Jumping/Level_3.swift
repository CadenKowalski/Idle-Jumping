...
class Level_3: UIViewController {
    ...
    @IBAction func ScreenTapped(_ sender: Any) {
        ...
        UIView.animate(withDuration: 0.1, animations: {self.Player.frame = CGRect(x: 66, y: 505, width: 273, height: 236)})
        UIView.animate(withDuration: 0.2, animations: {self.Player.frame = CGRect(x: 66, y: 576, width: 273, height: 236)})
