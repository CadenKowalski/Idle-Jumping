...
class Level_4: UIViewController {
    ...
    @IBAction func ScreenTapped(_ sender: Any) {
        ...
        UIView.animate(withDuration: 0.1, animations: {self.Player.frame = CGRect(x: 60, y: 490, width: 273, height: 236)})
        UIView.animate(withDuration: 0.2, animations: {self.Player.frame = CGRect(x: 60, y: 572, width: 273, height: 236)})
